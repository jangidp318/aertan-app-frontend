...
export default class Inbox extends React.Component{
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{fontSize:34, fontWeight:'bold',marginTop:50,marginVertical:10,marginHorizontal:20,}}>{'Trips'}</Text>
      <Text style={{fontSize:14, fontWeight:'bold',marginHorizontal:20,color:'gray'}}>{"Your Trips will be saved here."}</Text>
      <ScrollView 
      showsHorizontalScrollIndicator={false}
      style={styles.scrollView}>
        <Text style={{fontSize:16,textAlign:'center',marginVertical:200,color:'gray'}}>{'No Trips yet.'}</Text>
      </ScrollView>
      ...
      <TouchableOpacity style={{ height:50, width:50,marginVertical:5,marginHorizontal:10,borderRadius:10}}>
            <Image source={require('../assets/footerIcon/redTrip.png')}style={{flex:1,alignSelf:'center',marginTop:5}}/>
            <Text style={{fontSize:10,textAlign:'center',color:'#e75480'}}>Trips</Text>
      </TouchableOpacity>
