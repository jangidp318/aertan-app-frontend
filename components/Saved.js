...
export default class Inbox extends React.Component{
  ...
  render(){
    ...
    <View style={styles.container}>
        ...
        <Text style={{fontSize:34, fontWeight:'bold',marginTop:50,marginVertical:10,marginHorizontal:20,}}>{'Saved'}</Text>
        <Text style={{fontSize:14, fontWeight:'bold',marginHorizontal:20,color:'gray'}}>{"Your favourites will be saved here."}</Text>
      <ScrollView 
        showsHorizontalScrollIndicator={false}
        style={styles.scrollView}>
        <Text style={{fontSize:16,textAlign:'center',marginVertical:200,color:'gray'}}>{'Nothing is saved yet.'}</Text>
      </ScrollView>
      ...
      <TouchableOpacity style={{ height:50, width:50,marginVertical:5,marginHorizontal:10,borderRadius:10}} onPress={()=>{this.props.navigation.navigate('Saved')}}>
            <Image source={require('../assets/footerIcon/redHeart.png')}style={{flex:1,alignSelf:'center',marginTop:3}}/>
            <Text style={{fontSize:10,textAlign:'center',color:'#e75480'}}>Saved</Text>
      </TouchableOpacity>
